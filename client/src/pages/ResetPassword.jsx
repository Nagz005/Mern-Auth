...
const ResetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-gray-900 to-indigo-900">
      ...
      {/* --- Email Form --- */}
      {!isEmailSent && (
        <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg w-96 text-sm shadow-lg shadow-indigo-500/20">
      ...
      {!isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitOtp} className="bg-slate-900 p-8 rounded-lg w-96 text-sm shadow-lg shadow-indigo-500/20">
          ...
          <button type="submit" className="w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full hover:opacity-90">
            Submit
          </button>
        </form>
      )}
      ...
      {/* --- New Password Form --- */}
      {isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg w-96 text-sm shadow-lg shadow-indigo-500/20">
